...
def parse():
    ...
    parser.add_argument('--config_file', type=str, default='1train/component_correlation_analysis/config.py', help='the files of config')
    ...
    parser.add_argument('--log_dir', type=str, default='/results/logs/component/', help='path that log will be saved')
