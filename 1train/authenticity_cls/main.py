...
def main():
    ...
    if config['mode'] == 'predict':
        ...
        if config['kfold']:
            results_valid = {'loss': [], 'mse': [], 'accuracy': [], 'auc': [], 'mcc': [], 'f1': [], 'precision': [], 'recall': []}
            for fold in config['fold']:
                ...
                results_valid['mse'].append(res[1]['mse'])
                ...
                args.logger.info("Val - Loss {}  MSE {}  Accuracy {}  AUC {}  MCC {}  F1 {}  Precision {}  Recall {}"
                                .format(
