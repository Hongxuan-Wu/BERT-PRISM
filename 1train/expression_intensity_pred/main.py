...
def parse():
    ...
    parser.add_argument('--config_file', type=str, default='1train/expression_intensity_pred/config.py', help='the files of config')
    ...
    parser.add_argument('--log_dir', type=str, default='/results/logs/expression_pred/', help='path that log will be saved')
