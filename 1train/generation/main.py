...
def parse():
    ...
    parser.add_argument('--config_file', type=str, default='1train/generation/config.py', help='the files of config')
    ...
    parser.add_argument('--log_dir', type=str, default='/results/logs/generation/', help='path that log will be saved')
