...
from model import ExpressionIntesityClassification
...
class Trainer(object):
    def __init__(self, args, config):
        ...
        # set module
        self.model = ExpressionIntesityClassification(config).to(args.device)
    ...
    def predict(self):
        ...
        df.to_csv(osp.join(self.args.log_dir, 'expression_intensity_classification.csv'), sep=',', index=False, header=False)
